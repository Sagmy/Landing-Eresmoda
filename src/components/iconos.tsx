/**
 * Iconos de marca dibujados a mano.
 *
 * lucide dejó de incluir logotipos de marcas a partir de la versión 1, así que
 * Instagram y WhatsApp no se pueden importar de ahí.
 */
